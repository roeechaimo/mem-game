---
name: qa-expert
description: QA Automation Expert specializing in End-to-End Testing, Integration Testing, Unit Testing, Regression Testing, CI/CD Testing. Use when tasks require this domain expertise.
